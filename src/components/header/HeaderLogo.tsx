    ...
    <div className="flex items-center gap-3 cursor-pointer" onClick={() => setActiveTab('menu')}>
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <span className="hidden sm:inline-block px-2 py-0.5 bg-brand-50 text-brand-700 text-[10px] font-bold rounded-md border border-brand-100 uppercase tracking-wider">
            Excel Engine
          </span>
        </div>
